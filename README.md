...
The colour scales are generated by an OKLCH algorithm with per-step contrast
floors. Upgrading from an earlier (sRGB-mixed) version? See
[docs/migrating-to-oklch-colors.md](docs/migrating-to-oklch-colors.md).
